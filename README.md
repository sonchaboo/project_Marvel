...
Т.к. у нас были распарсенные данные на персонажей в файле new_features.csv (распарсены они были как описано в лаб. 1), мы сджойнили две таблички: test1_formatrix.csv и new_features.csv по имени.
Таким образом мы получили дополнительные данные по полу, национальности, статусу (жив/мертв) и виду.

Далее мы добавили кластеризацию по этим признакам, получив новые распределения по новым данным.
