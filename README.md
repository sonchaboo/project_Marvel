...
Мы сделали из наших данных матрицу смежности, после чего применили алгоритм draw_kamada_kawai и отдельно визуализировали по организациям, ролям, объединили это все вместе и попробовали придумать свой алгоритм. См. Сборка (2).
